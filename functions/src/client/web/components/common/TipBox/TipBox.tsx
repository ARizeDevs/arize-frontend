    ...
    return (
        <div onClick={onClick} className={styles.shadowedBox} style={style}>
            ...
            <div className={styles.textContainer} style={{marginLeft:'10px'}} >
                <h4 style={{textOverflow: 'ellipsis',overflow:'hidden',whiteSpace:'normal' , marginTop:'10px' ,width:'100%',height:'30px',fontSize:16, color:'#FF6F48'}}>{title}</h4>
                <div style={{width:'100%', fontSize:13,color:'#FF6F48'}}>
