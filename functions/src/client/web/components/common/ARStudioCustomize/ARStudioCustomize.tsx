...
const ARStudioPostDetail = (props : IProps) => {
    const { error,solidBackgroundColor,setSolidBackgroundColor,arButton,setArButton,shareButton,setShareButton, scaling,setScaling,actionButtonInfoTextColor,skyBox,setSkyBox,solidBackground, setSolidBackground,setActionButtonInfoTextColor, actionButtonInfoText, setActionButtonInfoText, autoPlay, hasShadow, setAutoPlay, setHasShadow, hasBackground, setHasBackground, buttonText, actionInfoBackgroundColor, setActionInfoBackgroundColor, onFinish , postBackgroundImageBase64, setPostBackgroundImageBase64, actionBUttonTextColor ,actionButtonColor, actionButtonLink, actionButtonText, onBack, setActionBUttonTextColor, setActionButtonColor, setActionButtonLink, setActionButtonText  } = props
            ...
            <div className={styles.inputWrapper}>
                    <Collapsible  triggerStyle={{cursor:'pointer', fontWeight:800,alignItems:'center',display:'flex',fontSize:16}} open={true} transitionTime={250} trigger={<div style={{width:'100%',paddingBottom:'10px', display:'flex',flexDirection:'row',justifyContent:'space-between'}}><p style={{display:'flex',flexDirection:'row',alignItems:'center'}}>3D View Setting</p><AngleDown></AngleDown></div>}>
                        ...
                        <div style={{width:'95%',marginBottom:20}}>
                                <ColorPicker  color={solidBackgroundColor} setColor={setSolidBackgroundColor} />
                        </div>}
