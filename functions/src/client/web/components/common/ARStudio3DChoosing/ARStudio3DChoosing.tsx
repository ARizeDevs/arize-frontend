    ...
    return (
        <div className={styles.root}>
            <div  className={styles.inputWrapper}>
                ...
                <SolidButton styleClass={styles.borderedBTN} colorTheme='white' onClick={OnLibraryChosen} ><h4 style={{ color : 'var(--main-blue-color)', textAlign:'left', margin:'10px',fontSize:16 }} >I don't have 3D files and want to choose from ARze Library</h4></SolidButton>
                <SolidButton styleClass={styles.borderedBTN} colorTheme='white' 
                    ...
                    ><h4 style={{ color : 'var(--main-blue-color)', textAlign:'left', margin:'10px',fontSize:16 }} >I don't have 3D files and want to submit a file cration request</h4></SolidButton>
            </div>
        </div>
    )
